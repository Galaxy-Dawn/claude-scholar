<div align="center">
  ...
  <p>
    ...
    <img src="https://img.shields.io/github/last-commit/Galaxy-Dawn/claude-scholar/kimi?style=flat-square" alt="Last Commit"/>
...
请让 `paper-miner` 把论文写作模式提炼到安装目录中的共享记忆。
`ml-paper-writing`、Nature 写作与润色、审稿回复 Skill 都可以读取相关内容。
