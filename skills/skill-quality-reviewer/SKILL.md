...
- "Evaluate this skill: ~/.kimi-code/skills/api-helper"
...
```bash
# Example invocation
ls -la ~/.kimi-code/skills/target-skill/
```
...
```
User: "Analyze skill quality for ~/.kimi-code/skills/git-workflow"
...
```
User: "Review all skills in ~/.kimi-code/skills and tell me what to fix first"
