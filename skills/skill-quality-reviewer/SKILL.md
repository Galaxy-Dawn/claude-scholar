...
- "Evaluate this skill: ~/.kimi/skills/api-helper"
...
```bash
# Example invocation
ls -la ~/.kimi/skills/target-skill/
```
...
```
User: "Analyze skill quality for ~/.kimi/skills/git-workflow"
...
```
User: "Review all skills in ~/.kimi/skills and tell me what to fix first"
