...
| Pattern | Description | Chinese Description |
|---------|-------------|----------|
...
| Dimension | Question | Chinese Question | Score |
|-----------|----------|----------|-------|
...
- **`examples/chinese.md`** - Chinese rewriting examples
