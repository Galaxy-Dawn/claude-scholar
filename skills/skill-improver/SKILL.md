...
**Backup location:** `~/.kimi-code/skills/backup/{skill-name}-{timestamp}/`

```bash
# Use backup script
~/.kimi-code/skills/skill-improver/scripts/backup-skill.sh <skill-path>
```
...
```bash
# Use verify script
~/.kimi-code/skills/skill-improver/scripts/verify-update.sh <skill-path>
```
